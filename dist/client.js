window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function registerReasoningSettings(ctx, { controller, component, t }) {
		...
		function ModelsReasoningComposite({ controller, slots, t, close }) {
		  ...
		  if (builtIn && typeof builtIn.component === "function") {
		    ...
		    modelsPage = h2(builtIn.component, { ...injected, close });
		  }
		  return h2(
		    "div",
		    ...
		    h2(
		      ...
		      h2("h2", { className: "dsh-reasoning-embed__title" }, t?.("nav") ?? "\u6A21\u578B\u63A8\u7406"),
		      h2(
		        "p",
		        { className: "dsh-reasoning-embed__hint" },
		        "\u4E3A\u81EA\u5B9A\u4E49 provider \u7684\u6BCF\u4E2A\u6A21\u578B\u8BBE\u7F6E\u63A8\u7406\u7B49\u7EA7\uFF1B\u4FDD\u5B58\u540E\u5373\u53EF\u5728\u6A21\u578B\u9009\u62E9\u5668\u4E2D\u5207\u6362\u3002"
		      ),
		      h2(ReasoningSettingsSection, { controller, embedded: true })
		    )
		  );
		}
